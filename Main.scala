...
7
    ...
    val worldRoot:Group = new Group(camVolume, lineX, lineY, lineZ, cylinder1)
    // Camera
    ...
    def partition(section: Section): Node={
      ...
      val slice = new Box((section._1._1._1+section._1._2)/2,(section._1._1._2+section._1._2)/2,(section._1._1._3+section._1._2)/2)
      slice
    }

    def checkpartition(oc:Octree[Placement],obj: Node): Unit = { oc match {
      case OcEmpty => Nil
      ...
      case OcLeaf(section) => {
        val slice = partition(section.asInstanceOf[Section])
        if(obj.getBoundsInLocal.intersects(slice.getBoundsInLocal)){
